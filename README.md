...
- ### Truy cap truc tiep
  ...
  > 1. Truy cap truc tiep lien ket:
  > - `https://todo-list-st8q.onrender.com/`
  > 2. Truy cap truc tiep bang command line:
  > - `open -a "google chrome" https://todo-list-st8q.onrender.com/`
